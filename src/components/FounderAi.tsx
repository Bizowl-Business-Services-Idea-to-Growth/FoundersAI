...
const FounderLandingPage: React.FC = () => {
    ...
    return (
        <div
            className={`min-h-screen antialiased transition-colors duration-300 ${isDarkMode ? "bg-gray-900 text-gray-100" : "bg-white text-gray-800"
                }`}
        >
            ...
            <section className="bg-[#1c6ed0] text-white flex items-center justify-center text-center px-4 py-20">
                <div>
                    ...
                    <p className="text-sm md:text-base text-blue-100">
                        Get personalized insights, actionable recommendations, and a clear
            ...
            <section
                className={`py-16 lg:py-24 transition-colors duration-300 ${isDarkMode ? "bg-gray-900" : "bg-white"
                    }`}
            >
                {!showForm ? (
                    <>
                        ...
                        <div className="bg-white shadow-md rounded-lg px-6 py-10 m-10 text-center">
                            ...
                            <h2
                                className={`text-3xl lg:text-4xl font-semibold mb-6 ${isDarkMode ? "text-gray-100" : "text-gray-900"
                                    }`}
                            >
                                Start Your <span className="text-[#1c6ed0]">Startup</span>{" "}
                                Assessment
                            </h2>
                            <p
                            ...
                            >
                                ...
                                startup stage, challenges, and aspirations. Takes just 5
                                minutes.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                                ...
                                <button
                                    className={`border-2 px-8 py-4 rounded-lg font-semibold transition-colors duration-200 ${isDarkMode
            ...
            <footer
                className={`pt-16 pb-8 transition-colors duration-300 ${isDarkMode ? "bg-black text-gray-300" : "bg-gray-900 text-white"
                    }`}
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                        <div>
                            ...
                            <p className="mb-4 text-gray-400">
                                Revolutionary AI-powered outsourcing solutions for modern
                                businesses. Focus on exponential growth while we handle
                                everything else.
                            </p>
                    ...
                    <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
                        <p className="text-sm text-gray-400 mb-4 md:mb-0">
                            © {new Date().getFullYear()} BizOwl AI. All rights reserved.
